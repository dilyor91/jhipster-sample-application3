...
import uz.tashkec.repository.CarRepository;
import uz.tashkec.service.dto.CarDTO;
import uz.tashkec.service.mapper.CarMapper;
...
class CarResourceIT {
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().name(DEFAULT_NAME).color(DEFAULT_COLOR);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().name(UPDATED_NAME).color(UPDATED_COLOR);
        return car;
    }
    ...
    void putExistingCar() throws Exception {
        ...
        updatedCar.name(UPDATED_NAME).color(UPDATED_COLOR);
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.name(UPDATED_NAME).color(UPDATED_COLOR);
