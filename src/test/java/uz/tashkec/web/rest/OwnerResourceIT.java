...
class OwnerResourceIT {
    ...
    public static Owner createEntity(EntityManager em) {
        Owner owner = new Owner().name(DEFAULT_NAME).family(DEFAULT_FAMILY);
        return owner;
    }
    ...
    public static Owner createUpdatedEntity(EntityManager em) {
        Owner owner = new Owner().name(UPDATED_NAME).family(UPDATED_FAMILY);
        return owner;
    }
    ...
    void createOwner() throws Exception {
        ...
        assertThat(testOwner.getFamily()).isEqualTo(DEFAULT_FAMILY);
    }
    ...
    void putExistingOwner() throws Exception {
        ...
        updatedOwner.name(UPDATED_NAME).family(UPDATED_FAMILY);
        ...
        assertThat(testOwner.getFamily()).isEqualTo(UPDATED_FAMILY);
    }
    ...
    void partialUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.family(UPDATED_FAMILY);
    ...
    void fullUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.name(UPDATED_NAME).family(UPDATED_FAMILY);
