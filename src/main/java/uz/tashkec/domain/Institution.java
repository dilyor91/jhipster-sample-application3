...
public class Institution implements Serializable {
    ...
    public Institution institutionType(InstitutType institutionType) {
    ...
    public Institution titleUz(String titleUz) {
    ...
    public Institution titleRu(String titleRu) {
    ...
    public Institution titleKr(String titleKr) {
    ...
    public Institution contentUz(String contentUz) {
    ...
    public Institution contentRu(String contentRu) {
    ...
    public Institution contentKr(String contentKr) {
    ...
    public Institution logoName(String logoName) {
    ...
    public Institution logoData(String logoData) {
    ...
    public void setFiles(Set<File> files) {
        if (this.files != null) {
            this.files.forEach(i -> i.setInstitution(null));
        }
        if (files != null) {
            files.forEach(i -> i.setInstitution(this));
        }
        this.files = files;
    }

    public Institution files(Set<File> files) {
        this.setFiles(files);
        return this;
    }

    public Institution addFile(File file) {
        this.files.add(file);
        file.setInstitution(this);
        return this;
    }

    public Institution removeFile(File file) {
        this.files.remove(file);
        file.setInstitution(null);
        return this;
    }
