...
public class News implements Serializable {
    ...
    public News titleUz(String titleUz) {
    ...
    public News titleKr(String titleKr) {
    ...
    public News contentUz(String contentUz) {
    ...
    public News contentRu(String contentRu) {
    ...
    public News contentKr(String contentKr) {
    ...
    public News postedDate(LocalDate postedDate) {
